...
<html>
    ...
    <body>
        ...
        <div class="container-80 d-flex justify-content-center pb-5" style="flex-direction: column;">
            <div>
                <a class="btn btn-info m-3 mx-5" href="<%= request.getContextPath()%>/admin/category/update?id=${category.id}" role="button">Update</a>
            </div>
            ...
            <div  class="card mt-3 p-4 d-flex flex-column mx-auto" style="width: 50rem;
                ...
                <div>
                    <a class="btn btn-primary" href="<%= request.getContextPath()%>/admin/product/create" role="button">Create</a>
                </div>
                <div class="card my-3">
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <a class="btn btn-danger" href="<%= request.getContextPath()%>/admin/product/delete?id=${c.id}" role="button">Delete</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <a class="btn btn-info" href="<%= request.getContextPath()%>/admin/product/detail?id=${c.id}" role="button">Detail</a></th>
                                    </th>
                                </tr>
                            </c:forEach>
                        </tbody>
