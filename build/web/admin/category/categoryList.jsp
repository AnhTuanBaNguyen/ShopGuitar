...
<html>
    ...
    <body>
        ...
        <div class="container-80 p-4 d-flex flex-column mx-auto">
            <div class="d-flex">
                <a class="btn btn-primary" href="<%= request.getContextPath()%>/admin/category/create" role="button">Create</a>
            </div>
            <div class="card my-3">
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <a class="btn btn-danger" href="<%= request.getContextPath()%>/admin/category/delete?id=${c.id}" role="button">Delete</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <a class="btn btn-info" href="<%= request.getContextPath()%>/admin/category/detail?id=${c.id}" role="button">Detail</a></th>
                                </th>
                            </tr>
                        </c:forEach>
                    </tbody>
